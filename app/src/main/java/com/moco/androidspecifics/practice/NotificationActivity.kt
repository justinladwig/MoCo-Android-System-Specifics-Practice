...
class NotificationActivity : ComponentActivity() {
    ...
    private fun playMedia() {
        mediaPlayer = MediaPlayer.create(this, R.raw.notification_ring).apply {
            isLooping = true
        }
        mediaPlayer?.start()
    }
...
fun NotificationScreen(modifier: Modifier = Modifier) {
    Box(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.notification_ring) /* TODO: Include the notification bell vector here */,
